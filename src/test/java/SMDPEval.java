...
public class SMDPEval {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./src/test/resources/CloudGrid_Nov.csv"))) { // CHANGE THIS FOR YOUR IMPLEMENTATION
            String line;
