...
public class SMDP_control {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./src/test/resources/CloudGrid_Aug.csv"))) { // CHANGE THIS FOR YOUR IMPLEMENTATION
            String line;
...
//        }
    ...
    public static SatelliteAction findNextAction(double time, HashMap<GeodeticPoint,Double> pointLibrary) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./results/xd_gdt_sat1.gdt"))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] values = line.split(",");
