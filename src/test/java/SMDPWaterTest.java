...
public class SMDPWaterTest {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./src/test/resources/WaterPoints.csv"))) { // CHANGE THIS FOR YOUR IMPLEMENTATION
            String line;
        ...
        try {
            FileWriter csvWriter = new FileWriter("./src/test/output/groundtrack.csv");
